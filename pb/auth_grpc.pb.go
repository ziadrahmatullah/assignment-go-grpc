...
type AuthServiceClient interface {
	...
	UserDetails(ctx context.Context, in *UserDetailsReq, opts ...grpc.CallOption) (*UserDetailsRes, error)
}
...
func (c *authServiceClient) UserDetails(ctx context.Context, in *UserDetailsReq, opts ...grpc.CallOption) (*UserDetailsRes, error) {
	out := new(UserDetailsRes)
	err := c.cc.Invoke(ctx, "/auth.AuthService/UserDetails", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	UserDetails(context.Context, *UserDetailsReq) (*UserDetailsRes, error)
...
func (UnimplementedAuthServiceServer) UserDetails(context.Context, *UserDetailsReq) (*UserDetailsRes, error) {
...
func _AuthService_UserDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.AuthService/UserDetails",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).UserDetails(ctx, req.(*UserDetailsReq))
	}
	return interceptor(ctx, in, info, handler)
}
